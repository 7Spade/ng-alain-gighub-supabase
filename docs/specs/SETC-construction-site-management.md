...
gantt
    ...
    section 第零階段
    帳戶與藍圖強化           :p0, 2025-01-06, 2w
    
    section 第一階段
    任務系統生產級           :p1, after p0, 4w
    
    section 第 1.5 階段
    檔案系統                 :p15, after p1, 2w
    
    section 第二階段
    日誌系統                 :p2, after p15, 2w
    
    section 第三階段
    進度追蹤儀表板           :p3, after p2, 3w
    
    section 第四階段
    品質驗收系統             :p4, after p3, 2w
    
    section 第五階段
    協作報表與上線           :p5, after p4, 4w
```
