 ...
 *
 * Display personal blueprints list with navigation to blueprint container
 * Following docs/00-順序.md Component layer standards
 *
 * Features:
 * - List personal blueprints
  ...
  template: `
    ...
    <nz-card [nzTitle]="'藍圖列表'">
      ...
      @if (!loading() && filteredBlueprints().length === 0) {
        <nz-empty [nzNotFoundContent]="'尚無藍圖'" [nzNotFoundFooter]="emptyFooter">
          <ng-template #emptyFooter>
            <button nz-button nzType="primary" (click)="onCreateBlueprint()"> 建立第一個藍圖 </button>
          </ng-template>
        </nz-empty>
      }
            ...
            <nz-col [nzSpan]="8">
              ...
              >
                ...
                <div class="blueprint-meta">
                  ...
                  <nz-tag [nzColor]="'default'">{{ blueprint.visibility }}</nz-tag>
